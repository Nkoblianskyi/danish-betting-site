    ...
    <main>
      ...
      <div className="container mx-auto py-8 px-4">
        ...
        <div className="prose max-w-none">
          ...
          <p>
            Gambling bør altid være en underholdende aktivitet og aldrig en måde at tjene penge på eller løse økonomiske
            problemer. Det er vigtigt at huske følgende principper:
          </p>
          ...
          <div className="space-y-4 mt-6">
            <div className="border p-4 rounded-lg bg-white bg-opacity-90">
              <div className="flex items-center mb-2">
                <Image src="/images/logos/stopspillet.png" alt="StopSpillet" width={60} height={30} className="mr-3" />
                <h3 className="font-bold text-xl">StopSpillet</h3>
              </div>
              <p>
                StopSpillet er Spillemyndighedens hjælpelinje, der tilbyder gratis og anonym rådgivning om problematisk
                spilleadfærd.
              </p>
              <p className="mt-2">
            ...
            <div className="border p-4 rounded-lg bg-white bg-opacity-90">
              <div className="flex items-center mb-2">
                <Image src="/images/logos/rofus.png" alt="ROFUS" width={60} height={30} className="mr-3" />
            ...
            <div className="border p-4 rounded-lg bg-white bg-opacity-90">
              ...
              <p>Center for Ludomani tilbyder gratis behandling til personer med spilleproblemer og deres pårørende.</p>
              <p className="mt-2">
          ...
          <div className="bg-gray-100 p-4 rounded-lg mt-8">
            ...
            <p className="text-lg">
              Gambling bør være sjovt og underholdende. Hvis det ikke længere er sjovt, er det tid til at tage en pause
              og søge hjælp.
            </p>
